/*
** Lua binding: NotificationClientService
** Generated automatically by tolua++-1.0.92 on 12/11/19 16:30:23.
*/
...
/* Exported function */
TOLUA_API int  tolua_NotificationClientService_open (lua_State* tolua_S);

#include "../Service/NotificationClientService.hpp"

/* function to register type */
static void tolua_reg_types (lua_State* tolua_S)
{
 tolua_usertype(tolua_S,"Packet");
 tolua_usertype(tolua_S,"NotificationClientService");
}
...
static int tolua_set_Packet_unsigned_protobuf_size(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->protobuf_size = ((unsigned short)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE

/* get function: message_flag of class  Packet */
#ifndef TOLUA_DISABLE_tolua_get_Packet_unsigned_message_flag
static int tolua_get_Packet_unsigned_message_flag(lua_State* tolua_S)
{
  Packet* self = (Packet*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'message_flag'",NULL);
#endif
  tolua_pushnumber(tolua_S,(lua_Number)self->message_flag);
 return 1;
}
#endif //#ifndef TOLUA_DISABLE

/* set function: message_flag of class  Packet */
#ifndef TOLUA_DISABLE_tolua_set_Packet_unsigned_message_flag
static int tolua_set_Packet_unsigned_message_flag(lua_State* tolua_S)
{
  Packet* self = (Packet*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->message_flag = ((unsigned short)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_DISABLE_tolua_get_NotificationClientService_Packet_protobuf_content
static int tolua_get_NotificationClientService_Packet_protobuf_content(lua_State* tolua_S)
{
 int tolua_index;
  Packet* self;
...
#ifndef TOLUA_DISABLE_tolua_set_NotificationClientService_Packet_protobuf_content
static int tolua_set_NotificationClientService_Packet_protobuf_content(lua_State* tolua_S)
{
 int tolua_index;
  Packet* self;
 lua_pushstring(tolua_S,".self");
...
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_Packet_CalculateCheckSum00
static int tolua_NotificationClientService_Packet_CalculateCheckSum00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_Packet_ProtobufString00
static int tolua_NotificationClientService_Packet_ProtobufString00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_Packet_Construct00
static int tolua_NotificationClientService_Packet_Construct00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_Packet_Destroy00
static int tolua_NotificationClientService_Packet_Destroy00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Instance of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Instance00
static int tolua_NotificationClientService_NotificationClientService_Instance00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"NotificationClientService",0,&tolua_err) ||
 ...
 {
  {
   NotificationClientService& tolua_ret = (NotificationClientService&)  NotificationClientService::Instance();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"NotificationClientService");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: Init of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Init00
static int tolua_NotificationClientService_NotificationClientService_Init00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"NotificationClientService",0,&tolua_err) ||
...
#endif
 {
  NotificationClientService* self = (NotificationClientService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: Start of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Start00
static int tolua_NotificationClientService_NotificationClientService_Start00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Stop of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Stop00
static int tolua_NotificationClientService_NotificationClientService_Stop00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Running of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Running00
static int tolua_NotificationClientService_NotificationClientService_Running00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Boot of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_Boot00
static int tolua_NotificationClientService_NotificationClientService_Boot00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ReadPacket of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_ReadPacket00
static int tolua_NotificationClientService_NotificationClientService_ReadPacket00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: WritePacket of class  NotificationClientService */
#ifndef TOLUA_DISABLE_tolua_NotificationClientService_NotificationClientService_WritePacket00
static int tolua_NotificationClientService_NotificationClientService_WritePacket00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_NotificationClientService_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"Packet");
   ...
   tolua_variable(tolua_S,"message_flag",tolua_get_Packet_unsigned_message_flag,tolua_set_Packet_unsigned_message_flag);
   tolua_array(tolua_S,"protobuf_content",tolua_get_NotificationClientService_Packet_protobuf_content,tolua_set_NotificationClientService_Packet_protobuf_content);
   tolua_function(tolua_S,"CalculateCheckSum",tolua_NotificationClientService_Packet_CalculateCheckSum00);
   tolua_function(tolua_S,"ProtobufString",tolua_NotificationClientService_Packet_ProtobufString00);
   tolua_function(tolua_S,"Construct",tolua_NotificationClientService_Packet_Construct00);
   tolua_function(tolua_S,"Destroy",tolua_NotificationClientService_Packet_Destroy00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"NotificationClientService","NotificationClientService","",NULL);
  tolua_beginmodule(tolua_S,"NotificationClientService");
   tolua_function(tolua_S,"Instance",tolua_NotificationClientService_NotificationClientService_Instance00);
   tolua_function(tolua_S,"Init",tolua_NotificationClientService_NotificationClientService_Init00);
   tolua_function(tolua_S,"Start",tolua_NotificationClientService_NotificationClientService_Start00);
   tolua_function(tolua_S,"Stop",tolua_NotificationClientService_NotificationClientService_Stop00);
   tolua_function(tolua_S,"Running",tolua_NotificationClientService_NotificationClientService_Running00);
   tolua_function(tolua_S,"Boot",tolua_NotificationClientService_NotificationClientService_Boot00);
   tolua_function(tolua_S,"ReadPacket",tolua_NotificationClientService_NotificationClientService_ReadPacket00);
   tolua_function(tolua_S,"WritePacket",tolua_NotificationClientService_NotificationClientService_WritePacket00);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
}
 ...
 TOLUA_API int luaopen_NotificationClientService (lua_State* tolua_S) {
 return tolua_NotificationClientService_open(tolua_S);
};
#endif
