/*
** Lua binding: NotificationService
** Generated automatically by tolua++-1.0.92 on 12/11/19 16:30:24.
*/
...
/* Exported function */
TOLUA_API int  tolua_NotificationService_open (lua_State* tolua_S);
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"NotificationService");
}
...
#ifndef TOLUA_DISABLE_tolua_get_NotificationService_Packet_protobuf_content
static int tolua_get_NotificationService_Packet_protobuf_content(lua_State* tolua_S)
{
 int tolua_index;
  Packet* self;
...
#ifndef TOLUA_DISABLE_tolua_set_NotificationService_Packet_protobuf_content
static int tolua_set_NotificationService_Packet_protobuf_content(lua_State* tolua_S)
{
 int tolua_index;
  Packet* self;
 lua_pushstring(tolua_S,".self");
...
#ifndef TOLUA_DISABLE_tolua_NotificationService_Packet_CalculateCheckSum00
static int tolua_NotificationService_Packet_CalculateCheckSum00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationService_Packet_ProtobufString00
static int tolua_NotificationService_Packet_ProtobufString00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationService_Packet_Construct00
static int tolua_NotificationService_Packet_Construct00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_NotificationService_Packet_Destroy00
static int tolua_NotificationService_Packet_Destroy00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Instance of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Instance00
static int tolua_NotificationService_NotificationService_Instance00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertable(tolua_S,1,"NotificationService",0,&tolua_err) ||
 ...
 {
  {
   NotificationService& tolua_ret = (NotificationService&)  NotificationService::Instance();
    tolua_pushusertype(tolua_S,(void*)&tolua_ret,"NotificationService");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
...
/* method: Init of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Init00
static int tolua_NotificationService_NotificationService_Init00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"NotificationService",0,&tolua_err) ||
...
#endif
 {
  NotificationService* self = (NotificationService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: Start of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Start00
static int tolua_NotificationService_NotificationService_Start00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Stop of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Stop00
static int tolua_NotificationService_NotificationService_Stop00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Running of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Running00
static int tolua_NotificationService_NotificationService_Running00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: Boot of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_Boot00
static int tolua_NotificationService_NotificationService_Boot00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ReadPacket of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_ReadPacket00
static int tolua_NotificationService_NotificationService_ReadPacket00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: WritePacket of class  NotificationService */
#ifndef TOLUA_DISABLE_tolua_NotificationService_NotificationService_WritePacket00
static int tolua_NotificationService_NotificationService_WritePacket00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_NotificationService_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"Packet");
   ...
   tolua_array(tolua_S,"protobuf_content",tolua_get_NotificationService_Packet_protobuf_content,tolua_set_NotificationService_Packet_protobuf_content);
   tolua_function(tolua_S,"CalculateCheckSum",tolua_NotificationService_Packet_CalculateCheckSum00);
   tolua_function(tolua_S,"ProtobufString",tolua_NotificationService_Packet_ProtobufString00);
   tolua_function(tolua_S,"Construct",tolua_NotificationService_Packet_Construct00);
   tolua_function(tolua_S,"Destroy",tolua_NotificationService_Packet_Destroy00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"NotificationService","NotificationService","",NULL);
  tolua_beginmodule(tolua_S,"NotificationService");
   tolua_function(tolua_S,"Instance",tolua_NotificationService_NotificationService_Instance00);
   tolua_function(tolua_S,"Init",tolua_NotificationService_NotificationService_Init00);
   tolua_function(tolua_S,"Start",tolua_NotificationService_NotificationService_Start00);
   tolua_function(tolua_S,"Stop",tolua_NotificationService_NotificationService_Stop00);
   tolua_function(tolua_S,"Running",tolua_NotificationService_NotificationService_Running00);
   tolua_function(tolua_S,"Boot",tolua_NotificationService_NotificationService_Boot00);
   tolua_function(tolua_S,"ReadPacket",tolua_NotificationService_NotificationService_ReadPacket00);
   tolua_function(tolua_S,"WritePacket",tolua_NotificationService_NotificationService_WritePacket00);
  tolua_endmodule(tolua_S);
 tolua_endmodule(tolua_S);
 return 1;
}
 ...
 TOLUA_API int luaopen_NotificationService (lua_State* tolua_S) {
 return tolua_NotificationService_open(tolua_S);
};
#endif
