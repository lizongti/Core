...
#define MYNAME		"special_base64"
#define MYVERSION	MYNAME " library for " LUA_VERSION " / Mar 2010"

#define uint unsigned int

static const char code[]=
"sY+N7PTnwM6bfAg4eaxkzCdhvJlUXZQSF82mDpK5WL/uEo31c0jiRtIHyqBOVGr9";
static char reverse_t[128] = {0};
...
LUALIB_API int luaopen_special_base64(lua_State *L)
{
  int i = 0;
  for (; i < 64; i++)
  {
