...
static const struct luaL_reg _pb [] = {
    ...
    {"varint_encoder64", varint_encoder},
    {"signed_varint_encoder", signed_varint_encoder},
    {"signed_varint_encoder64", signed_varint_encoder},
    {"varint_decoder", varint_decoder},
    {"varint_decoder64", varint_decoder},
    {"signed_varint_decoder", signed_varint_decoder},
    {"signed_varint_decoder64", signed_varint_decoder},
