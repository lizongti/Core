...
require "Module/SlotsThunderZeusSpin"
require "Module/SlotsBaseSpin"

module("SlotsThunderZeus", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsThunderZeusSpin, args)
