...
require "Module/SlotsIceAndFireSpin"
require "Module/SlotsBaseSpin"

module("SlotsIceAndFire", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsIceAndFireSpin, args)
...
BonusStart = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusStart()
end

BonusPick = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusPick()
end

BonusFinish = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
