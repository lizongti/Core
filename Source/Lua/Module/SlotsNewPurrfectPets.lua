...
require "Module/SlotsNewPurrfectPetsSpin"
require "Module/SlotsBaseSpin"

module("SlotsNewPurrfectPets", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsNewPurrfectPetsSpin, args)
...
do --WalkBonus
    BonusEnter = function(args)
        local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
        return SlotsGameSpin:BonusEnter()
    end

    BonusWalk = function(args)
        local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
        return SlotsGameSpin:BonusWalk()
    end

    BonusSettle = function(args)
        local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
        return SlotsGameSpin:BonusSettle()
    end
end

do --CollectBonus
    CollectEnter = function(args)
        local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
        return SlotsGameSpin:CollectEnter()
    end

    CollectOpenBox = function(args)
        local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
        return SlotsGameSpin:CollectOpenBox()
    end
end
