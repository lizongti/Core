...
require "Module/SlotsRumblingVolcanoSpin"
require "Module/SlotsBaseSpin"

module("SlotsRumblingVolcano", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsRumblingVolcanoSpin, args)
