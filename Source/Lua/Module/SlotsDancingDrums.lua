...
require "Module/SlotsDancingDrumsSpin"
require "Module/SlotsBaseSpin"

module("SlotsDancingDrums", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsDancingDrumsSpin, args)
...
DancingDrumsBonusStart = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    
    return SlotsGameSpin:DancingDrumsBonusStart()
end

DancingDrumsBonusFinish = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    
    return SlotsGameSpin:DancingDrumsBonusFinish()
end
