...
require "Module/SlotsNewBacktoJurassicSpin"
require "Module/SlotsBaseSpin"

module("SlotsNewBacktoJurassic", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsNewBacktoJurassicSpin, args)
