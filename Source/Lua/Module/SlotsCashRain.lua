...
require "Module/SlotsCashRainSpin"
require "Module/SlotsBaseSpin"

module("SlotsCashRain", package.seeall)
...
Enter = function(args)
    ...
    local priority_level = {
        ...
        [GameStatusDefine.AllTypes.HoldSpinGame] = 1,
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsCashRainSpin, args)
...
BonusWheelEnter = function(args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusWheelEnter()
end

BonusWheelClear = function(args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusWheelClear()
end

BonusWheelClick = function(args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusWheelClick()
end

BonusMoneyPickEnter = function(args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusMoneyPickEnter()
end

BonusMoneyPickFinish = function(args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    return SlotsGameSpin:BonusMoneyPickFinish()
end
