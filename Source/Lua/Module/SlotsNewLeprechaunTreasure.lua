...
require "Module/SlotsNewLeprechaunTreasureSpin"
require "Module/SlotsBaseSpin"

module("SlotsNewLeprechaunTreasure", package.seeall)
...
Enter = function(args)
    ...
    local SlotsGameSpin = SlotsBaseSpin:Create(SlotsNewLeprechaunTreasureSpin, args)
...
NewLeprechaunTreasureBonusStart = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    
    return SlotsGameSpin:NewLeprechaunTreasureBonusStart()
end

NewLeprechaunTreasureBonusFinish = function (args)
    local SlotsGameSpin = SlotsBaseSpin:InitParameters(args)
    
    return SlotsGameSpin:NewLeprechaunTreasureBonusFinish()
end
