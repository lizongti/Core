...
{
public:
    static int start(struct interface::context *context,
                     const char *module_name,
                     const char *service_name);

    static int send(struct interface::context *context,
                    const char *source,
                    const char *destination,
                    void *data);

    static int stop(struct interface::context *context,
                    const char *service_name);
};
...
public:
              ...
              const std::string &service_name)
    {
        ...
        {
            std::cerr
                << "Module " << module_name << " load failed!" << std::endl;
            return false;
        }
        context = std::shared_ptr<interface::context>(
        ...
        std::cout
            << "Service " << service_name << " load ok" << std::endl;
        return true;
    }
...
class service_loader
    : public detail::singleton<service_loader>,
...
public:
                                         ...
                                         std::string const &service_name)
    {
        ...
        if (service_unordered_map.find(service_name) !=
    ...
    static std::shared_ptr<service> push(std::string const &service_name,
                                         std::shared_ptr<interface::message>
                                             message)
    {
